<?php
    ...
    function criar_rodape($extra){
        echo "  <div class='rodapeC'>
                ...
                <div id='patrocinadores'>
                    <div class='container'>
                        <div class='row align-items-center' style='text-align: center'>
                            ...
                            <div class='col'>
                                <img src='arquivos/imagens/patrocinadores/prefeitura.png' class='pt-image'/>
                            </div>
                            <div class='col'>
                            ...
                            <div class='col'>
                                <img src='arquivos/imagens/patrocinadores/sicredi-logo2.png' class='pt-image'/>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class='rodapeR'>
                    <div class='container'>
                        <h6 style='text-align: center;'><strong>FECITEC</strong> © 2019 - <a href='https://github.com/xfelipesobral' target='_BLANK' style='color: #fff'>Felipe V. Sobral</a></h6> 
                    </div>
                </div>
