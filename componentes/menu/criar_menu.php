<?php
    ...
    function criar_menu(){
        ...
        $menu->dropdown("Anais", [[xurl("anais")."&ano=2019", "2019"], [xurl("anais")."&ano=2018", "2018"], [xurl("anais")."&ano=2017", "2017"], [xurl("anais")."&ano=2016", "2016"], [xurl("anais")."&ano=2015", "2015"], [xurl("anais")."&ano=2014", "2014"], [xurl("anais")."&ano=2013", "2013"], [xurl("anais")."&ano=2012", "2012"], [xurl("anais")."&ano=2011", "2011"]]);
