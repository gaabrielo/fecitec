...
function Inscricao() {
  ...
  const informacoesDoProjeto = () => (
    <div className="formularioInformacoesProjeto">
      ...
      <FormControl
        fullWidth
        sx={{ marginTop: 1, marginBottom: 2, flexDirection: 'row' }}
      >
        <TextField
          id="inscricaoTitulo"
          label="Título"
      ...
      <Alert severity="warning" sx={{ mt: 2 }}>
        Recomendamos salvar o resumo em um arquivo separado.
      </Alert>
    </div>
  );
    ...
    <div className="formularioInstituicoesEnsino">
      ...
      <FormControl fullWidth sx={{ marginTop: 1 }}>
        <Autocomplete
          ...
          renderInput={(params) => (
            <TextField {...params} id="" required label="Instituição" />
          )}
        />
  ...
  const professor = () => (
    <div className="formularioProfessor">
      ...
      <FormControl fullWidth sx={{ marginTop: 1 }}>
        ...
        <FormControl
          fullWidth
          sx={{ marginTop: 2, marginBottom: 2, flexDirection: 'row' }}
        >
          <TextField
      ...
      <Alert severity="warning">
        Esteja atento ao e-mail informado, uma cópia da inscrição será enviada
        para ele. Se não receber a cópia da inscrição no seu e-mail, favor
        entrar em contato com a comissão pelo e-mail{' '}
        <a href="mailto:fecitec.ufpr@gmail.com">fecitec.ufpr@gmail.com</a> para
        confirmar a sua inscrição do projeto.
      </Alert>
    </div>
  );
  ...
  const alunos = () => (
    <div className="formularioAlunos">
      ...
      <p>
        As equipes serão compostas por no máximo 3 alunos, com exceção do ensino
        infantil que poderão ser compostas por até 6 alunos
      </p>
      ...
      {qtdAlunos.map((item, i) => (
        <FormControl
          key={`aluno${i}`}
          fullWidth
          sx={{ marginTop: 2, flexDirection: 'row' }}
        >
          <TextField
  ...
  const observacoes = () => (
    <div className="formularioObservacoes">
      <h2>Observações</h2>
      <p>
        Se o projeto não for de Palotina, escrever aqui o nome da sua cidade,
        estado e da escola/colégio. Escrever outras observações que achar
        necessário.
      </p>

      <FormControl fullWidth sx={{ mt: 2 }}>
        <TextField id="inscricaoObservacoes" label="Observações" multiline />
      </FormControl>
    </div>
  );
      ...
      <FormControl sx={{ marginTop: 2, marginBottom: 2 }}>
        <FormGroup>
          <FormControlLabel
            control={
              <Switch
                id="inscricaoInformacoesVeridicas"
                required
                color="warning"
              />
            }
  ...
  const recursos = () => (
    <div className="formularioRecursos">
      ...
      <FormControl fullWidth sx={{ marginTop: 1 }}>
        <TextField id="inscricaoLocalEspecifico" label="Local específico" />
  ...
  const enviar = async () => {
    ...
    if (retorno?.sucesso) {
      ...
      setPopup({
        ...
        mensagem:
          retorno?.erro ||
          'Não foi possível enviar sua inscrição via e-mail, favor entrar em contato com a comissão pelo e-mail fecitec.ufpr@gmail.com!',
      });
    }
  };
  ...
  return (
    <div id="inscricao">
      ...
      <Titulo
        descricao="Preencha todos campos atentamente e envie seu projeto"
        texto="Inscrições até 28/08"
      />
